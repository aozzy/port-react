...
const data = [
  {
    ...
    techUsedDesc:false,
    additionalTechUsed:[<img width="40" height="40" src="https://img.icons8.com/ios-filled/50/visual-studio.png" alt="visual-studio"/>],
  }, 
  {
    id: 2,
    title:"Project 2",
    ...
    openingDesc:"Project 2 was a pair programming Hackathon project in which we had to build a React application that consumes a public API. The duration of the project was two days, My classmate Fabien Depasse and I built the Breaking Bad project as we both enjoyed the tv series.",
    ...
    additionalTechUsed:[ <img width="40" height="40" src="https://img.icons8.com/ios-filled/50/visual-studio.png" alt="visual-studio"/>,<img width="40" height="40" src="https://img.icons8.com/wired/64/babel.png" alt="babel"/>],
  },
  {
    id:3,
    title:"Project 3",
    ...
    openingDesc:"For the third project we were tasked as a group to build a full-stack application by making our own backend and front-end. The duration of the project was 9 days and worked in a group of four. As a group we decided we wanted to build a travel site.",
    ...
    additionalTechUsed:[<img width="40" height="40" src="https://img.icons8.com/ios-filled/50/css3.png" alt="css3"/>, <img width="40" height="40" src="https://img.icons8.com/ios-filled/50/visual-studio.png" alt="visual-studio"/>],
  ...
  },
  {
    ...
    openingDesc:"Blog central is a full stack application I built in a week.The app utilises full Crud capabilities, users are able to login/register and post blog content. The app is a solo project",
  ...
  },
  {
    ...
    additionalTechUsed:[<img width="40" height="40" src="https://img.icons8.com/ios/50/html-filetype--v1.png" alt="html-filetype--v1"/>,<img width="40" height="40" src="https://img.icons8.com/ios-filled/50/css3.png" alt="css3"/>],
  },
  {
    id:7,
    title:"Sidescroller",
